  ...
  obx_int.ModelEntity(
    ...
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 5989465330461716494),
        name: 'id',
        type: 6,
        flags: 1,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 6179076091976835522),
        name: 'nodesJson',
        type: 9,
        flags: 0,
      ),
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
    ...
    entities: _entities,
    lastEntityId: const obx_int.IdUid(1, 3273020002033156455),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    MetroGraphModel: obx_int.EntityDefinition<MetroGraphModel>(
      model: _entities[0],
      toOneRelations: (MetroGraphModel object) => [],
      toManyRelations: (MetroGraphModel object) => {},
      getId: (MetroGraphModel object) => object.id,
      setId: (MetroGraphModel object, int id) {
        object.id = id;
      },
...
/// [MetroGraphModel] entity fields to define ObjectBox queries.
class MetroGraphModel_ {
  /// See [MetroGraphModel.id].
  static final id = obx.QueryIntegerProperty<MetroGraphModel>(
    _entities[0].properties[0],
  );

  /// See [MetroGraphModel.nodesJson].
  static final nodesJson = obx.QueryStringProperty<MetroGraphModel>(
